                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('dealer.completeprofile_save') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="description" class="form-control @error('description') is-invalid @enderror" name="description" required>{{ old('description', isset($user) ? $user->description : '') }}</textarea>
