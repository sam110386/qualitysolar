            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('leads.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="title" class="col-md-4 col-form-label text-md-right">@lang('cruds.lead.fields.title')</label>
                        ...
                        <div class="form-group row">
                            <label for="content" class="col-md-4 col-form-label text-md-right">@lang('cruds.lead.fields.content')</label>
                        ...
                        <div class="form-group row">
                            <label for="attachments" class="col-md-4 col-form-label text-md-right">{{ trans('cruds.lead.fields.attachments') }}</label>
