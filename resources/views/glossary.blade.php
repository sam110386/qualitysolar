...
@section('content')
<section class="banner_sec dictionary-bnr">
	<div class="container text-center">
		<div class="banner_text ">
			<h2 class="white_text head_h1">EV Dictionary</h2>

		</div>
	</div>
</section>

<section class="smplTxt">
	<div class="container text-center">
		<p>Electric vehicles and charging does not have to be
			a mystery. We've created this EV Dictionary for industry terms and simple explanations of them.</p>
	</div>
</section>

<section class="pricing-sec padd_b60">
			...
			<div class="col-lg-4 col-md-6">
				<div class="pricing-box">
					<div class="dflex align-items-center">
						...
						<div class=" text-center">
							<a href="#" class="pull text-dark">AC (Alternating Current)</a>
							<div class="pull-show d-none">
								An electric current that reverses direction at regular intervals.
							</div>
						</div>
						<div class=" text-center">
							<a href="#" class="pull text-dark">Amp (Ampere) (A)</a>
							<div class="pull-show d-none">
			...
			<div class="col-lg-4 col-md-6">
				<div class="pricing-box">
					<div class="dflex align-items-center">
						...
						<div class=" text-center">
							<a href="#" class="pull text-dark">BEV (Battery Electric Vehicle)</a>
							<div class="pull-show d-none">
								One hundred percent battery-powered Electric Vehicle.
							</div>
						</div>
						<!-- <div class=" text-center">
							<a href="#" class="pull text-dark">BP</a>
							<div class="pull-show d-none">
								Amp Lorum Ipsum
							</div>
						</div> -->
			...
			<div class="col-lg-4 col-md-6">
				<div class="pricing-box">
					<div class="dflex align-items-center">
						...
						<div class=" text-center">
							<a href="#" class="pull text-dark">CCS (Combined Charging System) (J1772)</a>
							<div class="pull-show d-none">
						...
						<div class=" text-center">
							<a href="#" class="pull text-dark">CONNECTOR</a>
							<div class="pull-show d-none">
			...
			<div class="col-lg-4 col-md-6">
				<div class="pricing-box">
					<div class="dflex align-items-center">
						...
						<div class=" text-center">
							<a href="#" class="pull text-dark">DC (Direct Current)</a>
							<div class="pull-show d-none">
								An electric current of constant direction.
							</div>
						</div>
						<div class=" text-center">
							<a href="#" class="pull text-dark">DCFC (DC FAST CHARGE)</a>
							<div class="pull-show d-none">
			...
			<div class="col-lg-4 col-md-6">
				<div class="pricing-box">
					<div class="dflex align-items-center">
						...
						<div class=" text-center">
							<a href="#" class="pull text-dark">EREV (Extended-Range Electric Vehicle)</a>
							<div class="pull-show d-none">
								Although the electric motor of an EV drives the wheels, EREVs have an auxiliary power unit, usually an internal combustion engine, that acts as a generator to recharge the battery when it runs out.
								Examples of an EREV are the Chevrolet Volt.
							</div>
						</div>
						<div class=" text-center">
							<a href="#" class="pull text-dark">EV (Electric Vehicle)</a>
							<div class="pull-show d-none">
								Any vehicle that uses electric motors, either in full or in part, as propulsion. These include BEVs, HEVs, and PHEVs.
							</div>
						</div>
						<div class=" text-center">
							<a href="#" class="pull text-dark">EVSE (Electric Vehicle Supply Equipment)</a>
							<div class="pull-show d-none">
			...
			<div class="col-lg-4 col-md-6">
				<div class="pricing-box">
					<div class="dflex align-items-center">
						...
						<div class=" text-center">
							<a href="#" class="pull text-dark">FCEV (Fuel Cell Electric Vehicle)</a>
							<div class="pull-show d-none">
			...
			<div class="col-lg-4 col-md-6">
				<div class="pricing-box">
					<div class="dflex align-items-center">
						...
						<!-- <div class=" text-center">
							<a href="#" class="pull text-dark">GC</a>
							<div class="pull-show d-none">
								GC Lorum Ipsum
							</div>
						</div>
						<div class=" text-center">
							<a href="#" class="pull text-dark">Gmp</a>
							<div class="pull-show d-none">
								Amp Lorum Ipsum
							</div>
						</div> -->
			...
			<div class="col-lg-4 col-md-6">
				<div class="pricing-box">
					<div class="dflex align-items-center">
						...
						<div class=" text-center">
							<a href="#" class="pull text-dark">HEV (Hybrid Electric Vehicle)</a>
							<div class="pull-show d-none">
						...
						<!-- <div class=" text-center">
							<a href="#" class="pull text-dark">HP</a>
							<div class="pull-show d-none">
								Hmp Lorum Ipsum
							</div>
						</div> -->
			...
			<div class="col-lg-4 col-md-6">
				<div class="pricing-box">
					<div class="dflex align-items-center">
						...
						<div class=" text-center">
							<a href="#" class="pull text-dark">INCENTIVES</a>
							<div class="pull-show d-none">
			...
			<div class="col-lg-4 col-md-6">
				<div class="pricing-box">
					<div class="dflex align-items-center">
						...
						<div class=" text-center">
							<a href="#" class="pull text-dark">Kilowatt</a>
							<div class="pull-show d-none">
								A measure of 1,000 watts of electrical power.
							</div>
						</div>
						<div class=" text-center">
							<a href="#" class="pull text-dark">KWH (Kilowatt-Hour)</a>
							<div class="pull-show d-none">
			...
			<div class="col-lg-4 col-md-6">
				<div class="pricing-box">
					<div class="dflex align-items-center">
						...
						<div class=" text-center">
							<a href="#" class="pull text-dark">LEVEL 1 CHARGING (Slow or Trickle Charge)</a>
							<div class="pull-show d-none">
						...
						<div class=" text-center">
							<a href="#" class="pull text-dark">LEVEL 2 CHARGING</a>
							<div class="pull-show d-none">
						...
						<div class=" text-center">
							<a href="#" class="pull text-dark">LEVEL 3 CHARGING (DC FAST CHARGING)</a>
							<div class="pull-show d-none">
						...
						<div class=" text-center">
							<a href="#" class="pull text-dark">LITHIUM-ION BATTERY</a>
							<div class="pull-show d-none">
			...
			<div class="col-lg-4 col-md-6">
				<div class="pricing-box">
					<div class="dflex align-items-center">
						...
						<div class=" text-center">
							<a href="#" class="pull text-dark">PHEV (Plug-In Hybrid Electric Vehicle)</a>
							<div class="pull-show d-none">
						...
						<div class=" text-center">
							<a href="#" class="pull text-dark">PURE ELECTRIC</a>
							<div class="pull-show d-none">
			...
			<div class="col-lg-4 col-md-6">
				<div class="pricing-box">
					<div class="dflex align-items-center">
						...
						<div class=" text-center">
							<a href="#" class="pull text-dark">RANGE (ELECTRIC RANGE)</a>
							<div class="pull-show d-none">
								The distance you can travel on electric power before the battery requires a recharge.
							</div>
						</div>
						<div class=" text-center">
							<a href="#" class="pull text-dark">RANGE ANXIETY</a>
							<div class="pull-show d-none">
						...
						<div class=" text-center">
							<a href="#" class="pull text-dark">RATE (EV CHARGING RATE)</a>
							<div class="pull-show d-none">
								A rate based upon the amount of electricity used by a customer to charge their electric vehicle.
							</div>
						</div>
						<div class=" text-center">
							<a href="#" class="pull text-dark">REGENERATIVE BRAKING</a>
							<div class="pull-show d-none">
			...
			<div class="col-lg-4 col-md-6">
				<div class="pricing-box">
					<div class="dflex align-items-center">
						...
						<div class=" text-center">
							<a href="#" class="pull text-dark">SAE-J1772</a>
							<div class="pull-show d-none">
			...
			<div class="col-lg-4 col-md-6">
				<div class="pricing-box">
					<div class="dflex align-items-center">
						...
						<div class=" text-center">
							<a href="#" class="pull text-dark">TORQUE (INSTANT TORQUE)</a>
							<div class="pull-show d-none">
			...
			<div class="col-lg-4 col-md-6">
				<div class="pricing-box">
					<div class="dflex align-items-center">
						...
						<div class=" text-center">
							<a href="#" class="pull text-dark">UTILITY</a>
							<div class="pull-show d-none">
			...
			<div class="col-lg-4 col-md-6">
				<div class="pricing-box">
					<div class="dflex align-items-center">
						...
						<div class=" text-center">
							<a href="#" class="pull text-dark">VOLT</a>
							<div class="pull-show d-none">
...
<script>
	$(document).ready(function() {
		$(".pull").click(function(e) {
			e.preventDefault();
			$(this).siblings('.pull-show').toggleClass("d-none");
			$(this).toggleClass('text-dark text-warning');
			/*if ($(".price_tble").hasClass("text-warning")) {
				$(this).text("See Less");
			} else {
				$(this).text("See More");
			};*/
